...
Events.init({
    ...
    espeakers: {type: eng.DataTypes.TEXT, allowNull: true},
    esponsors: {type: eng.DataTypes.TEXT, allowNull: true},
    eexhibitors: {type: eng.DataTypes.TEXT, allowNull: true},
    egallery: {type: eng.DataTypes.TEXT, allowNull: true},
